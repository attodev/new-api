...
// ollamaToolCallsToOpenAI converts Ollama's tool_calls shape to the OpenAI
// ToolCallResponse shape, assigning sequential call IDs (and, for the
// streaming delta path, an index) starting at startIndex.
