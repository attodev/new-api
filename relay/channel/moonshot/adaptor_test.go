...
// TestConvertOpenAIRequestKimiK26UsesOnlyAllowedTemperature reproduces a
// real bug: kimi-k2.6 only accepts temperature=1.0, but the adaptor was a
// pure pass-through with no per-model normalization, so any other client
// temperature was sent verbatim and rejected or mishandled upstream.
