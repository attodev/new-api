...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	...
	if info.RelayMode == relayconstant.RelayModeRealtime {
		// OpenAI retired the Realtime Beta API; GA models reject requests
		// carrying the beta marker with beta_api_shape_disabled. Only the
		// legacy "*-realtime-preview" models still need it.
