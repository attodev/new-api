...
// TestModelPriceHelperTieredPreConsumeMaxTokensFallback reproduces a real
// under-reservation bug: when a client omits max_tokens on a tiered_expr
// model, pre-consume estimated 0 completion tokens - reserving nothing
// against the wallet even though the model can go on to generate a full
// response.
