...
// QuotaData stores bar chart data
...
func SaveQuotaDataCache() {
	...
	// if cache has data, save it to the database
	...
	common.SysLog(fmt.Sprintf("dashboard data saved successfully, %d records saved", size))
}
...
func GetQuotaDataByUsername(username string, startTime int64, endTime int64) (quotaData []*QuotaData, err error) {
	...
	// query data from the quota_data table
