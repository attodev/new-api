...
func enableTossBillingForTest(t *testing.T) {
	...
	setting.TossBillingClientKey = "ck_test_wallet_auto_billing"
	setting.TossBillingSecretKey = "sk_test_wallet_auto_billing"
...
func TestWalletAutoRechargeTossConfirmIssueFailureReleasesPendingPolicy(t *testing.T) {
	...
	walletAutoRechargeBillingKeyIssuer = func(ctx context.Context, authKey, customerKey, idempotencyKey string) (*tossBillingIssueResponse, int, error) {
