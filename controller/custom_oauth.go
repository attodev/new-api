...
func FetchCustomOAuthDiscovery(c *gin.Context) {
	...
	if err := c.ShouldBindJSON(&req); err != nil {
		common.ApiErrorI18n(c, i18n.MsgCustomOAuthInvalidParams, map[string]any{"Error": err.Error()})
		return
	}
	...
	if wellKnownURL == "" && issuerURL == "" {
		common.ApiErrorI18n(c, i18n.MsgCustomOAuthDiscoveryEmpty)
		return
	}
	...
	if err != nil || parsedURL.Host == "" || (parsedURL.Scheme != "http" && parsedURL.Scheme != "https") {
		common.ApiErrorI18n(c, i18n.MsgCustomOAuthDiscoveryInvalid)
		return
	}
	...
	if err != nil {
		common.ApiErrorI18n(c, i18n.MsgCustomOAuthDiscoveryFailed, map[string]any{"Error": err.Error()})
		return
	}
	...
	if resp.StatusCode != http.StatusOK {
		...
		common.ApiErrorI18n(c, i18n.MsgCustomOAuthDiscoveryFailed, map[string]any{"Error": message})
		return
	}

	var discovery map[string]any
	if err = common.DecodeJson(resp.Body, &discovery); err != nil {
		common.ApiErrorI18n(c, i18n.MsgCustomOAuthDiscoveryParseFail, map[string]any{"Error": err.Error()})
		return
	}
...
func CreateCustomOAuthProvider(c *gin.Context) {
	...
	if oauth.IsProviderRegistered(req.Slug) && !oauth.IsCustomProvider(req.Slug) {
		common.ApiErrorI18n(c, i18n.MsgCustomOAuthSlugConflict)
		return
	}
...
func DeleteCustomOAuthProvider(c *gin.Context) {
	...
	if err != nil {
		...
		common.ApiErrorI18n(c, i18n.MsgCustomOAuthCheckBindingFailed)
		return
	}
	if count > 0 {
		common.ApiErrorI18n(c, i18n.MsgCustomOAuthDeleteHasBindings)
		return
	}
...
func GetUserOAuthBindings(c *gin.Context) {
	userId := c.GetInt("id")
	if userId == 0 {
		common.ApiErrorI18n(c, i18n.MsgCustomOAuthNotLoggedIn)
		return
	}
