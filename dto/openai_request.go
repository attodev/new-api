...
type OpenAIResponsesRequest struct {
	...
	// Responses API; they are forwarded verbatim for OpenAI-compatible
	// upstreams (e.g. vLLM) that accept them.
	...
	// ClientMetadata carries Codex CLI conversation/session metadata:
